...
export default function TextBox({name, value = '', onChange = null, extra = {}}) {
    // init
    const {type = 'text', id = name, alias, placeholder, multiple, validation, regex, isReadonly, isDisabled, translation} = extra;
    if(type === 'color' && value === '') {
        value = '#585d93';
    }
    ...
    const commonProps = {
        id,
        name,
        ...(type !== 'file' && { value: (onChange ? value : defaultValue) }),
